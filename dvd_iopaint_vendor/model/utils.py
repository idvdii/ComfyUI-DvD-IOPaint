...
from dvd_iopaint_vendor.schema import SDSampler
...
def handle_from_pretrained_exceptions(func, **kwargs):
    try:
        ...
        if "RevisionNotFoundError: 404 Client Error." in previous_traceback:
            ...
            raise RuntimeError(
                "Fetching the model from Hugging Face failed. Configure network "
                "access or place the model in the local model directory."
            ) from e
        raise e
    except Exception as e:
        raise e
